                  ...
                  >
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-right">
                        ...
                        <p
                          className={`text-sm mt-1 ${isCompleted ? "text-gray-300" : booking.status === "Confirmed" ? "text-green-400" : "text-red-400"}`}
                        >
                          {statusText}
                        </p>
                      </div>
                      ...
                      <div className="mt-4 bg-black/40 border border-white/15 rounded-xl p-4">
                        <div className="text-sm text-gray-200 space-y-1 mb-4">
                          ...
                          <p>
                            ...
                            {booking.base_fare ?? booking.total_fare}
                          </p>
                          <p>
